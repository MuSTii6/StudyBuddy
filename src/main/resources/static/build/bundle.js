...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			img2 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "images/study-together.jpg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "d-block w-100");
    			attr_dev(img0, "width", "1000");
    			attr_dev(img0, "height", "855");
    			attr_dev(img0, "alt", "study-together");
    			add_location(img0, file$4, 3, 12, 175);
    			attr_dev(div0, "class", "carousel-item active");
    			add_location(div0, file$4, 2, 8, 127);
    			if (!src_url_equal(img1.src, img1_src_value = "images/study-together-2.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "d-block w-100");
    			attr_dev(img1, "width", "1000");
    			attr_dev(img1, "height", "855");
    			attr_dev(img1, "alt", "study-together-2");
    			add_location(img1, file$4, 6, 12, 348);
    			attr_dev(div1, "class", "carousel-item");
    			add_location(div1, file$4, 5, 8, 307);
    			if (!src_url_equal(img2.src, img2_src_value = "images/study-together-3.jpg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "class", "d-block w-100");
    			attr_dev(img2, "width", "1000");
    			attr_dev(img2, "height", "855");
    			attr_dev(img2, "alt", "study-together-3");
    			add_location(img2, file$4, 9, 12, 525);
    			attr_dev(div2, "class", "carousel-item");
    			add_location(div2, file$4, 8, 8, 484);
    			attr_dev(div3, "class", "carousel-inner");
    			add_location(div3, file$4, 1, 4, 89);
    ...
    /* src\pages\Student.svelte generated by Svelte v3.55.0 */

    const { console: console_1$2 } = globals;
    const file$3 = "src\\pages\\Student.svelte";
    ...
    // (94:8) {#each students as student}
    function create_each_block$2(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*student*/ ctx[1].email + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*student*/ ctx[1].name + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(td0, file$3, 95, 16, 2461);
    			add_location(td1, file$3, 96, 16, 2503);
    			add_location(tr, file$3, 94, 12, 2439);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*students*/ 1 && t0_value !== (t0_value = /*student*/ ctx[1].email + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*students*/ 1 && t2_value !== (t2_value = /*student*/ ctx[1].name + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(94:8) {#each students as student}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h10 = element("h1");
    			h10.textContent = "Als Lernpartner registrieren";
    			t4 = space();
    			form = element("form");
    			div1 = element("div");
    			div0 = element("div");
    			label0 = element("label");
    			label0.textContent = "Mailadresse";
    			t6 = space();
    			...
    			t12 = space();
    			h11 = element("h1");
    			h11.textContent = "Liste registrierter Studenten";
    			t14 = space();
    			table = element("table");
    			thead = element("thead");
    			tr = element("tr");
    			th0 = element("th");
    			th0.textContent = "E-Mail";
    			t16 = space();
    			th1 = element("th");
    			...
    			add_location(br0, file$3, 51, 0, 1310);
    			add_location(br1, file$3, 52, 0, 1316);
    			add_location(br2, file$3, 53, 0, 1322);
    			attr_dev(h10, "class", "mt-3");
    			add_location(h10, file$3, 54, 0, 1328);
    			attr_dev(label0, "class", "form-label");
    			attr_dev(label0, "for", "email");
    			add_location(label0, file$3, 58, 12, 1468);
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "email");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 59, 12, 1539);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$3, 57, 8, 1437);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$3, 56, 4, 1405);
    			attr_dev(label1, "class", "form-label");
    			attr_dev(label1, "for", "name");
    			add_location(label1, file$3, 69, 12, 1797);
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "name");
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$3, 70, 12, 1860);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file$3, 68, 8, 1766);
    			attr_dev(div3, "class", "row mb-3");
    			add_location(div3, file$3, 67, 4, 1734);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$3, 79, 4, 2063);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$3, 55, 0, 1380);
    			add_location(h11, file$3, 84, 0, 2178);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$3, 88, 12, 2280);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$3, 89, 12, 2321);
    			add_location(tr, file$3, 87, 8, 2262);
    			add_location(thead, file$3, 86, 4, 2245);
    			add_location(tbody, file$3, 92, 4, 2381);
    			attr_dev(table, "class", "table");
    			add_location(table, file$3, 85, 0, 2218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*student*/ ctx[1].email);
    			append_dev(form, t7);
    			...
    			set_input_value(input1, /*student*/ ctx[1].name);
    			append_dev(form, t10);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*createStudent*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*student*/ 2 && input0.value !== /*student*/ ctx[1].email) {
    				set_input_value(input0, /*student*/ ctx[1].email);
    			}

    			if (dirty & /*student*/ 2 && input1.value !== /*student*/ ctx[1].name) {
    				set_input_value(input1, /*student*/ ctx[1].name);
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let students = [];
    	let student = { email: null, name: null };

    	function getStudents() {
    		var config = {
    			method: "get",
    			url: api_root$2 + "/api/student",
    			headers: {}
    		};

    		axios(config).then(function (response) {
    			$$invalidate(0, students = response.data);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Student> was created with unknown prop '${key}'`);
    	});

    	function input0_input_handler() {
    		student.email = this.value;
    		$$invalidate(1, student);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('student' in $$props) $$invalidate(1, student = $$props.student);
    	};
    	...
    	return [students, student, createStudent, input0_input_handler, input1_input_handler];
    }
    ...
    /* src\pages\Modul.svelte generated by Svelte v3.55.0 */

    const { console: console_1$1 } = globals;
    const file$2 = "src\\pages\\Modul.svelte";
    ...
    // (83:8) {#each module as modul}
    function create_each_block$1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*modul*/ ctx[1].modulname + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*modul*/ ctx[1].studentId + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(td0, file$2, 84, 16, 2038);
    			add_location(td1, file$2, 85, 16, 2082);
    			add_location(tr, file$2, 83, 12, 2016);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*module*/ 1 && t0_value !== (t0_value = /*modul*/ ctx[1].modulname + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*module*/ 1 && t2_value !== (t2_value = /*modul*/ ctx[1].studentId + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(tr);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(83:8) {#each module as modul}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h10 = element("h1");
    			h10.textContent = "Modul hinzufügen";
    			t3 = space();
    			form = element("form");
    			div1 = element("div");
    			div0 = element("div");
    			label = element("label");
    			label.textContent = "Modulname";
    			t5 = space();
    			input = element("input");
    			t6 = space();
    			button = element("button");
    			...
    			t8 = space();
    			h11 = element("h1");
    			h11.textContent = "Alle Module";
    			t10 = space();
    			table = element("table");
    			thead = element("thead");
    			tr = element("tr");
    			th0 = element("th");
    			th0.textContent = "Modulname";
    			t12 = space();
    			th1 = element("th");
    			th1.textContent = "StudentId";
    			t14 = space();
    			tbody = element("tbody");
    			...
    			add_location(br0, file$2, 50, 0, 1217);
    			add_location(br1, file$2, 51, 0, 1223);
    			attr_dev(h10, "class", "mt-3");
    			add_location(h10, file$2, 53, 0, 1231);
    			attr_dev(label, "class", "form-label");
    			attr_dev(label, "for", "modulname");
    			add_location(label, file$2, 57, 12, 1359);
    			attr_dev(input, "class", "form-control");
    			attr_dev(input, "id", "modulname");
    			attr_dev(input, "type", "text");
    			add_location(input, file$2, 58, 12, 1432);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$2, 56, 8, 1328);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$2, 55, 4, 1296);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$2, 67, 4, 1639);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$2, 54, 0, 1271);
    			add_location(h11, file$2, 72, 0, 1756);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$2, 76, 12, 1840);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$2, 77, 12, 1884);
    			add_location(tr, file$2, 75, 8, 1822);
    			add_location(thead, file$2, 74, 4, 1805);
    			add_location(tbody, file$2, 81, 4, 1962);
    			attr_dev(table, "class", "table");
    			add_location(table, file$2, 73, 0, 1778);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*modul*/ ctx[1].modulname);
    			append_dev(form, t6);
    			append_dev(form, button);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*createModul*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*modul*/ 2 && input.value !== /*modul*/ ctx[1].modulname) {
    				set_input_value(input, /*modul*/ ctx[1].modulname);
    			}

    			if (dirty & /*module*/ 1) {
    				each_value = /*module*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let module = [];
    	let modul = { modulname: null, studentId: null };

    	function getModul() {
    		var config = {
    			method: "get",
    			url: api_root$1 + "/api/modul",
    			headers: {}
    		};

    		axios(config).then(function (response) {
    			$$invalidate(0, module = response.data);
    		}).catch(function (error) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Modul> was created with unknown prop '${key}'`);
    	});

    	function input_input_handler() {
    		modul.modulname = this.value;
    		$$invalidate(1, modul);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('modul' in $$props) $$invalidate(1, modul = $$props.modul);
    	};
    	...
    	return [module, modul, createModul, input_input_handler];
    }
    ...
    /* src\pages\ByModul.svelte generated by Svelte v3.55.0 */

    const { console: console_1 } = globals;
    const file$1 = "src\\pages\\ByModul.svelte";
    ...
    // (49:8) {#each bymodule as bymodul}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*bymodul*/ ctx[3].id + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*bymodul*/ ctx[3].studenten + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(td0, file$1, 50, 16, 999);
    			add_location(td1, file$1, 51, 16, 1038);
    			add_location(tr, file$1, 49, 12, 977);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*bymodule*/ 1 && t0_value !== (t0_value = /*bymodul*/ ctx[3].id + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*bymodule*/ 1 && t2_value !== (t2_value = /*bymodul*/ ctx[3].studenten + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(tr);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:8) {#each bymodule as bymodul}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			h10 = element("h1");
    			h10.textContent = "Module und zugewiesene Studenten";
    			t6 = space();
    			table = element("table");
    			thead = element("thead");
    			tr = element("tr");
    			...
    			t14 = space();
    			h11 = element("h1");
    			h11.textContent = "Student kontaktieren für eine Lernpartnerschaft";
    			t16 = space();
    			form = element("form");
    			input0 = element("input");
    			br8 = element("br");
    			t17 = space();
    			h60 = element("h6");
    			h60.textContent = "Gib hier deine Nachricht ein:";
    			input1 = element("input");
    			t19 = space();
    			br9 = element("br");
    			t20 = space();
    			...
    			t21 = space();
    			h61 = element("h6");
    			h61.textContent = "Gib hier deine Mailadresse ein:";
    			...
    			add_location(br0, file$1, 31, 0, 669);
    			add_location(br1, file$1, 32, 0, 675);
    			add_location(br2, file$1, 33, 0, 681);
    			add_location(br3, file$1, 34, 0, 687);
    			add_location(br4, file$1, 35, 0, 693);
    			add_location(h10, file$1, 39, 0, 705);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$1, 43, 12, 810);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$1, 44, 12, 854);
    			add_location(tr, file$1, 42, 8, 792);
    			add_location(thead, file$1, 41, 4, 775);
    			add_location(tbody, file$1, 47, 4, 919);
    			attr_dev(table, "class", "table");
    			add_location(table, file$1, 40, 0, 748);
    			add_location(br5, file$1, 58, 0, 1132);
    			add_location(br6, file$1, 59, 0, 1138);
    			add_location(br7, file$1, 60, 0, 1144);
    			add_location(h11, file$1, 63, 0, 1154);
    			attr_dev(input0, "type", "hidden");
    			attr_dev(input0, "name", "_subject");
    			input0.value = "Anfrage für Lernpartnerschaft";
    			add_location(input0, file$1, 66, 4, 1297);
    			add_location(br8, file$1, 66, 80, 1373);
    			add_location(h60, file$1, 67, 4, 1383);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "name");
    			attr_dev(input1, "placeholder", "Deine Nachricht");
    			input1.required = true;
    			set_style(input1, "width", "30em");
    			add_location(input1, file$1, 67, 42, 1421);
    			add_location(br9, file$1, 68, 4, 1518);
    			add_location(br10, file$1, 69, 4, 1528);
    			add_location(h61, file$1, 70, 4, 1538);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "name", "Mail des Absenders");
    			attr_dev(input2, "placeholder", "Deine Mailadresse");
    			input2.required = true;
    			set_style(input2, "width", "30em");
    			add_location(input2, file$1, 70, 44, 1578);
    			add_location(br11, file$1, 71, 4, 1692);
    			add_location(br12, file$1, 72, 4, 1702);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 73, 4, 1712);
    			attr_dev(input3, "type", "hidden");
    			attr_dev(input3, "name", "_captcha");
    			input3.value = "false";
    			add_location(input3, file$1, 74, 4, 1755);
    			attr_dev(form, "action", "https://formsubmit.co/uzdilmus@students.zhaw.ch");
    			attr_dev(form, "method", "POST");
    			add_location(form, file$1, 65, 0, 1214);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function getBymodul() {
    		...
    		axios(config).then(function (response) {
    			$$invalidate(0, bymodule = response.data);
    		}).catch(function (error) {
    			alert("Could not get module");
    			console.log(error);
    		});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<ByModul> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('bymodule' in $$props) $$invalidate(0, bymodule = $$props.bymodule);
    		if ('student' in $$props) student = $$props.student;
    	};
    ...
    class ByModul extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const config = {
        domain: "dev-1318lcns27leyer2.us.auth0.com",
        clientId: "2RniNHadtRglOXB3tpVKmOES6WwAsrMn"
        };
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(a, "color", "aqua");
    			set_style(a, "font-weight", "bold");
    			attr_dev(a, "href", "#/modul");
    			add_location(a, file, 80, 9, 1852);
    			attr_dev(li, "class", "nav-item");
    			add_location(li, file, 79, 8, 1820);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(79:7) {#if $isAuthenticated}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 105, 10, 2518);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 96, 10, 2267);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 99, 10, 2354);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(96:9) {#if $isAuthenticated}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div7 = element("div");
    			a0 = element("a");
    			a0.textContent = "Welcome to StudyBuddy, the platform to prepare together for exams";
    			t2 = space();
    			...
    			li1 = element("li");
    			a2 = element("a");
    			a2.textContent = "Studenten";
    			t10 = space();
    			if (if_block0) if_block0.c();
    			t11 = space();
    			li2 = element("li");
    			a3 = element("a");
    			a3.textContent = "Module nach Studenten";
    			t13 = space();
    			div3 = element("div");
    			if_block1.c();
    			attr_dev(div0, "class", "container");
    			add_location(div0, file, 9, 1, 205);
    			attr_dev(div1, "id", "app");
    			add_location(div1, file, 8, 0, 188);
    			attr_dev(a0, "class", "navbar-brand");
    			set_style(a0, "margin-left", "32em");
    			set_style(a0, "color", "aqua");
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file, 22, 2, 371);
    			attr_dev(span, "class", "navbar-toggler-icon");
    			add_location(span, file, 35, 3, 707);
    			...
    			add_location(button0, file, 28, 2, 532);
    			attr_dev(h5, "class", "offcanvas-title");
    			attr_dev(h5, "id", "offcanvasDarkNavbarLabel");
    			add_location(h5, file, 49, 4, 1072);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn-close btn-close-white");
    			attr_dev(button1, "data-bs-dismiss", "offcanvas");
    			attr_dev(button1, "aria-label", "Close");
    			add_location(button1, file, 52, 4, 1164);
    			attr_dev(div2, "class", "offcanvas-header");
    			add_location(div2, file, 48, 3, 1036);
    			attr_dev(a1, "class", "nav-link active");
    			attr_dev(a1, "aria-current", "page");
    			set_style(a1, "color", "white");
    			set_style(a1, "font-weight", "bold");
    			attr_dev(a1, "href", "#/");
    			add_location(a1, file, 62, 6, 1444);
    			attr_dev(li0, "class", "nav-item");
    			add_location(li0, file, 61, 5, 1415);
    			attr_dev(a2, "class", "nav-link");
    			set_style(a2, "color", "aqua");
    			set_style(a2, "font-weight", "bold");
    			attr_dev(a2, "href", "#/student");
    			add_location(a2, file, 70, 6, 1637);
    			attr_dev(li1, "class", "nav-item");
    			add_location(li1, file, 69, 5, 1608);
    			attr_dev(a3, "class", "nav-link");
    			set_style(a3, "color", "aqua");
    			set_style(a3, "font-weight", "bold");
    			attr_dev(a3, "href", "#/bymodul");
    			add_location(a3, file, 89, 8, 2051);
    			attr_dev(div3, "class", "d-flex");
    			add_location(div3, file, 94, 8, 2202);
    			attr_dev(li2, "class", "nav-item");
    			add_location(li2, file, 88, 7, 2020);
    			attr_dev(ul0, "class", "navbar-nav justify-content-end flex-grow-1 pe-3");
    			add_location(ul0, file, 60, 4, 1348);
    			attr_dev(div4, "class", "offcanvas-body");
    			add_location(div4, file, 59, 3, 1314);
    			attr_dev(div5, "class", "offcanvas offcanvas-end text-bg-dark");
    			attr_dev(div5, "tabindex", "-1");
    			attr_dev(div5, "id", "offcanvasDarkNavbar");
    			attr_dev(div5, "aria-labelledby", "offcanvasDarkNavbarLabel");
    			add_location(div5, file, 42, 2, 879);
    			attr_dev(ul1, "class", "navbar-nav me-auto mb-2 mb-lg-0");
    			add_location(ul1, file, 39, 3, 822);
    			attr_dev(div6, "class", "collapse navbar-collapse");
    			attr_dev(div6, "id", "navbarNav");
    			add_location(div6, file, 38, 2, 764);
    			attr_dev(div7, "class", "container-fluid");
    			add_location(div7, file, 21, 1, 338);
    			attr_dev(nav, "class", "navbar navbar-dark bg-dark fixed-top");
    			add_location(nav, file, 20, 0, 285);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
